...
int main() {
	...
	static const float interleaved2[] = {
		//     X      Y     Z       R     G    B
			...
			-0.5f,  0.f,  0.5f,  0.3f, 0.2f, 0.5f,
			 0.5f,  0.f,  0.5f,  1.f,  0.5f, 0.5f,
	...
	while (!glfwWindowShouldClose(window)) {
		...
		transform3 = glm::translate(glm::mat4(1.0f), glm::vec3(0, glm::sin(static_cast<float>(thisFrame)), 0.f));
		transform3 = glm::rotate(transform3, static_cast<float>(thisFrame), glm::vec3(0, 1, 0));
