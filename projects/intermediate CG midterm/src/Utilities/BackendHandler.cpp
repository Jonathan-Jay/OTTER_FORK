...
void BackendHandler::GlfwWindowResizedCallback(GLFWwindow* window, int _width, int _height)
{
	width = _width;
	height = _height;
	...
	FrameEffects::Constant->Resize(width, height);
}
...
bool BackendHandler::InitGLFW()
{
	...
	window = glfwCreateWindow(width, height, "INFR1350U", nullptr, nullptr);
