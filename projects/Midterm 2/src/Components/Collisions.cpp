...
void Collisions::Update(entt::registry* reg, float deltaTime)
{
    ...
    for (auto entity : bulletView) {
        ...
        glm::vec3 pos = trans.SetPosition(trans.GetLocalPosition() + bull.getMovement() * deltaTime).GetLocalPosition();
        int bounce = 1;
        ...
        for (auto entity2 : view) {
            ...
            glm::vec3 pos2 = trans2.GetLocalPosition();
    ...
    for (auto entity : view) {
        ...
        if (coll.dead) {                //dead things do smt different
            glm::vec3 pos1 = trans.GetLocalPosition();
